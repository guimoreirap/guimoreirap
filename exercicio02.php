...
<body>
    ...
    <div class="container ">
    <h1> 2) Crie um formulário web que receba 4 notas, calcule a média dentre as notas e retorne o valor da média.</h1>

        <form name="form" method="post" action="exercicio02.php">
            ...
            <div class="mb-3">
                ...
                <input name="nota4" type="number" class="form-control" id="nota4" aria-describedby="nota4Help"> 
            </div>
